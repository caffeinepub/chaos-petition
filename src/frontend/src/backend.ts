...
export class Backend implements backendInterface {
    ...
    async createSignature(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createSignature(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getSignatureCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getSignatureCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSignatures(): Promise<Array<Signature>> {
        if (this.processError) {
            try {
